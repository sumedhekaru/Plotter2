function keep_lp_auto_calibration
...
%fn1 = 'C:\Users\daqop\Desktop\Sumedhe\Calibration\Auto\20110808\K02\lp2_auto';
...
cal_fn = 'selected_lp2_cal_data.txt';
...
for i = 3:L;    
    ...
    if strcmp(ext,'txt')
        ...
        data=textscan(dfID,'%s %f %f %f', 'headerLines', 1)
        fclose(dfID);
        break
    end
end
