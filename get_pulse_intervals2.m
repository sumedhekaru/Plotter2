...
%           'PulseIntervalData2-yyyymmdd.csv' format. If the file already
...
%       2014-03-05 Renamed as get_pulse_intervals2 to consider as a
%       different program. and changed the saving file name for data.
