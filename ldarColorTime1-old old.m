    ...
    for nc=1:size(map,1)
        ...
        for i1 = 1:length(iv)
            ...
            elseif sum(x(iv(i1)) ==  CG(:,6)/1000) >= 1 ...                
                && sum(y(iv(i1)) == CG(:,7)/1000) >= 1
                %disp('CG')
                hLine  = plot(x(iv(i1)),y(iv(i1)),'s','color',map(nc,:),'markerfacecolor',map(nc,:),'MarkerSize',mz);
            ...
            elseif sum(x(iv(i1)) ==  PBFA(:,3)/1000) >= 1 ...                
                && sum(y(iv(i1)) == PBFA(:,4)/1000) >= 1
                hLine = plot(x(iv(i1)),y(iv(i1)),'d','color',map(nc,:),'markerfacecolor',map(nc,:),'MarkerSize',mz+1);
            ...
            elseif sum(x(iv(i1)) ==  PBFAA(:,3)/1000) >= 1 ...                
                && sum(y(iv(i1)) == PBFAA(:,4)/1000) >= 1
                hLine = plot(x(iv(i1)),y(iv(i1)),'p','color',map(nc,:),'markerfacecolor',map(nc,:),'MarkerSize',mz+1);
            ...
            elseif sum(x(iv(i1)) ==  PBFAO(:,3)/1000) >= 1 ...                
                && sum(y(iv(i1)) == PBFAO(:,4)/1000) >= 1
                hLine = plot(x(iv(i1)),y(iv(i1)),'v','color',map(nc,:),'markerfacecolor',map(nc,:),'MarkerSize',mz+1);
