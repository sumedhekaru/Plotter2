...
if nargin < 1
    ...
    %fn = 'C:\Users\sumedhe\Downloads\Radar Test\test.netcdf';
    fn = 'C:\data\2011-08-05 -- 2011-08-16\data\netCDF\MEL\2011\08\14\19\KMLB20110814_190618_V03.netcdf';
    eleAngNum = 1;
    figure
else
    fn = sen_set.radarFn;
...
%[x0, y0] = latlon2xy(stLat,-stLon,0,34.363885,89.535414);
