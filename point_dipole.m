function [P, px, py, pz, ki_sqrd] = point_dipole(xyz,sns,dEms,output)
% This function is written to find point 3-D dipole estimation when 
% E change values are known at 3 or more sensors. 
% 
...
if output
    ...
    fprintf('P Px Py Pz \t = [%5.1f %5.1f %5.1f %5.1f %0.2e]\n',sqrt(sum(x.^2)),x,ki_sqrd)
...
dEt = a.k*(2*x(3)./R.^3 - 6*a.z0./R.^5.*((a.sen_set.x(a.sns)-a.x0)*x(1) + ...
    (a.sen_set.y(a.sns)-a.y0)*x(2) + (a.sen_set.z(a.sns)-a.z0)*x(3)));
