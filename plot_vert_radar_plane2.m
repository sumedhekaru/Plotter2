...
% fn = 'C:\data\2011-07-17 -- 2011-08-04\data\netCDF\2011\08\01\19\KMLB20110801_193725_V03.netcdf';
% 
% xxx2 = -34.07;
% xxx1 = -9.523;
% yyy2 = 29.38;
...
%xxx1 =  -14.5682; yyy1 =  -13.1148; xxx2 =   23.7610; yyy2 =   -1.6748;
%fn = 'T:\2011-08-05 -- 2011-08-16\data/netCDF/MEL/2011/08/14/22/KMLB20110814_221328_V03.netcdf';

%fn = 'T:\2011-08-05 -- 2011-08-16\data/netCDF/MEL/2011/08/14/22/KMLB20110814_222202_V03.netcdf';
%xxx1 = -2.3019; yyy1 =  9.5278; xxx2 =  12.4205; yyy2 =  -27.6644;
%xxx1 =   -13.5368; yyy1 =  -16.4295; xxx2 = 23.6554; yyy2 =   -1.7071;
...
wbh = waitbar(0,'Collecting verticle radar data','name','Radar');
...
%         end
   ...
   %% Let's work on plotting vertical plane 
    ...
    % distance of the current point (which is P1 now) to P2
    cDist = sqrt((x1 - x2)^2+(y1-y2)^2);
...
%         end
        ...
        xycn(1,:) = [x y cind2(sub2ind([L1,L2],n1,n2)) n1 nextN2];
%         if eleAngNum == 10
%            figure(500); hold all;
%            plot([lx1,lx2],[ly1,ly2],'b')
%            
%         end
        
        
        % Consider going theta wall 2        
        lx1 = r1/1000*sind(a2)+x0/1000;
        ly1 = r1/1000*cosd(a2)+y0/1000;        
        lx2 = r2/1000*sind(a2)+x0/1000;
        ly2 = r2/1000*cosd(a2)+y0/1000;
        ...
        xycn(2,:) = [x y cind2(sub2ind([L1,L2],n1,n2)) n1 nextN2];
%         if eleAngNum == 10
%            figure(500); hold all;
%             pg = plot([lx1,lx2],[ly1,ly2],'r');
%            
%             plot(xx,yy,'ko')
%            
%            fprintf('%f\t%f\t%f\t%f\t%f\t%f\n',lx1,ly1,lx2,ly2,x,y)
%         end
        ...
        [x,y] = intersection(lx1,ly1,lx2,ly2,xxx1,yyy1,xxx2,yyy2);
        nextN1 = n1 - 1;
        xycn(3,:) = [x y cind2(sub2ind([L1,L2],n1,n2)) nextN1 n2];
        
%         if eleAngNum == 10
%            figure(500); hold all;
%            plot([lx1,lx2],[ly1,ly2],'k')           
%         end
        ...
        [x,y] = intersection(lx1,ly1,lx2,ly2,xxx1,yyy1,xxx2,yyy2);
        nextN1 = n1 + 1;
        xycn(4,:) = [x y cind2(sub2ind([L1,L2],n1,n2)) nextN1 n2];
        
%         if eleAngNum == 10
%            figure(500); hold all;
%            plot([lx1,lx2],[ly1,ly2],'g')           
%         end
        
        % distance from point2 to inersections        
        dists = sqrt((xxx2 - xycn(:,1)).^2+(yyy2-xycn(:,2)).^2);
        [mdist, mInd] = min(dists);
...
for k = 1:length(vD)
    ...
    ke_ae = 8494.7;
    r_sq = (vx - x0/1000).^2 + (vy - y0/1000).^2;
...
if sen_set. pbfaOOn   
    ...
    if exist(pbfa_old_fn,'file')
        ...
        [t,x,y,z] = limitData(PBFAO(:,6),PBFAO(:,3)/1000,PBFAO(:,4)/1000,PBFAO(:,5)/1000,xL1,xL2,yL1,yL2);
